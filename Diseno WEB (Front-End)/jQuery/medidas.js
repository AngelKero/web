$(document).ready(function () {
    ...
    info.append('Ancho total: ' + titulo.outerWidth() + '<br>');
    
    // .outerWidth(true)
    // Calcula el ancho del elemento + el padding + el borde + margin
    info.append('Ancho Externo: ' + titulo.outerWidth(true) + '<br>');//Agregar valor true para calcular el margin
    ...
    info.append('Alto total: ' + titulo.outerHeight() + '<br>');
    
    // .outerHeight()
    // Calcula el alto del elemento + el padding + el borde + margin
	info.append('Alto Externo: ' + titulo.outerHeight(true) + '<br>');//Agregar valor true para calcular el margin
});